...
/*
    Ici on préfère poser toute les constantes dans un fichier à part pour une
   meilleur lisibilité et pour que tout soit au même endroit.
...
inline constexpr double RHO_EAU = 1;         // mg/mm³

inline constexpr double ETA_AIR = 1.8e-2; // mg/mm*s
inline constexpr double ETA_EAU = 1;      // mg/mm*s
